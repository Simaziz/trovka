        ...
        <div className=" rounded-2xl w-[700px] mt-1">
          <div className="flex justify-center items-center ">
            <img
              ...
              className="bg-yellow-500 rounded-full aspect-square h-[90px] w-[90px]"
            />
          </div>

          <div className="mt-8 text-2xl font-bold text-blue-900 text-center">
            General Information
          </div>
          ...
          <div className="mt-9 text-lg text-blue-800 max-md:max-w-full">
            Company Name
          </div>
          <input
            type="text"
          ...
          <div className="flex gap-5 mt-6 max-md:flex-wrap">
            <div className="flex flex-col flex-1 grow shrink-0 basis-0 w-fit">
              <div className="text-lg text-blue-800">First Name</div>
              <input
                type="text"
            ...
            <div className="flex flex-col flex-1 grow shrink-0 basis-0 w-fit">
              <div className="text-lg text-blue-800">Last Name</div>
              <input
                type="text"
          ...
          <div className="flex gap-5 mt-6 max-md:flex-wrap">
            <div className="flex flex-col flex-1 grow shrink-0 whitespace-nowrap basis-0 w-fit">
              <div className="text-lg text-blue-800">Username</div>
              <input
                type="text"
                className="rounded-lg w-[320px]"
            ...
            <div className="flex flex-col flex-1 grow shrink-0 basis-0 w-fit">
              <div className="text-lg text-blue-800">Phone Number</div>
              <input
                type="text"
                className="rounded-lg w-[340px]"
          ...
          <div className="flex gap-5 mt-6 max-md:flex-wrap">
            <div className="flex flex-col flex-1 grow shrink-0 basis-0 w-fit">
              <div className="text-lg text-blue-800">Category</div>
              <input
                type="text"
                className="rounded-lg w-[320px]"
            ...
            <div className="flex flex-col flex-1 grow shrink-0 whitespace-nowrap basis-0 w-fit">
              <div className="text-lg text-blue-800">Types</div>
              <input
                type="text"
                className="rounded-lg w-[340px]"
                placeholder="Types"
          ...
          <div className="flex justify-center items-center">
            <div className="justify-center items-center px-5 py-4 mt-14 max-w-full text-xl font-bold  text-center text-white whitespace-nowrap bg-yellow-300 rounded-2xl w-[250px] max-md:px-5 max-md:mt-10">
              Submit
            </div>
          </div>
        </div>
